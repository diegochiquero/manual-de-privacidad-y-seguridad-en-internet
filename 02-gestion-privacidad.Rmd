...
La privacidad en Internet se refiere al control de la información personal que posee un determinado usuario que se conecta a Internet, interactuando por medio de diversos servicios en línea con los que intercambia datos durante la navegación. Por ello, en esta unidad vas a lograr de aprender a gestionar la privacidad de manera inteligente para así evitar males mayores que podrían hacer de tu vida privada un terreno en el que de seguro no te gustaría estar [@WIKI-privacidad].
