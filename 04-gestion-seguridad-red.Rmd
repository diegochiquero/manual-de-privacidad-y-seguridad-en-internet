...
- [Cómo crear contraseñas con reglas mnemotécnicas](https://www.youtube.com/watch?v=dRSiu13_AUk)
...
Y por último, si quieres conocer los 5 métodos más usados por los ciberdelincuentes para el robo de contraseñas échale un ojo la al siguiente enlace [Cómo hacen los hackers para robar la contraseña: los 5 métodos más usados](https://www.lavanguardia.com/andro4all/tecnologia/como-hacen-los-hackers-para-robar-la-contrasena-los-5-metodos-mas-usados)
...
-  Utiliza plataformas que identifican webs fraudulentas como [Fakeinet](https://fakeinet.com/) o  [Desenmascarame](https://desenmascara.me/) que disponen de un listado de posibles tiendas falsas. 
