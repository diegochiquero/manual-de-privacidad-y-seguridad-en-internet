...
Si quieres, también puedes usar un generador de contraseñas fuertes como el que te ofrece [F-secure](https://www.f-secure.com/en/home/free-tools/password-generator) o [Pinetools](https://pinetools.com/es/generador-contrasenas).
...
[¿Cuáles son los tipos de certificados SSL?](https://www.globalsign.com/es/centro-de-informacion-ssl/tipos-de-certificados-ssl) o este otro [Diferencias y tipos de certificados de seguridad SSL](https://www.softrending.com/blog/tipos-diferencias-certificado-seguridad-ssl).
...
- Busca valoraciones y opiniones: Para ello dispones de las reseñas de Google maps, así como también de plataformas como [Trust Pilot](https://es.trustpilot.com/), [Gowork](https://es.gowork.com/), [Local guides connect](https://www.localguidesconnect.com/) o [TripAdvisor](https://www.tripadvisor.es/).

- Utiliza plataformas que valoran la reputación online de un portal, como [Scamadviser](https://www.scamadviser.com/), [Fakeinet](https://fakeinet.com/) o [Desenmascarame](https://desenmascara.me/) que dispone de un listado de posibles tiendas falsas.
