...
- [Learn to check](https://learntocheck.org/)
...
```{r, echo=FALSE, out.width='75%', fig.align='center', fig.cap='Deepfake.'}
knitr::include_graphics("images/deepfake.jpg")
```
...
](https://www.incibe.es/linea-de-ayuda-en-ciberseguridad/casos-reales/intento-de-fraude-amoroso-utilizando-tecnicas-de-deepfake-para-suplantar-un-personaje-publico).
