...
\hypertarget{cuentas-de-usuario-en-equipos-locales-y-dispositivos-muxf3viles}{%
...
\item
  \href{https://www.youtube.com/watch?v=dRSiu13_AUk}{Cómo crear contraseñas con reglas mnemotécnicas}
\end{itemize}
...
Y por último, si quieres conocer los 5 métodos más usados por los ciberdelincuentes para el robo de contraseñas échale un ojo la al siguiente enlace \href{https://www.lavanguardia.com/andro4all/tecnologia/como-hacen-los-hackers-para-robar-la-contrasena-los-5-metodos-mas-usados}{Cómo hacen los hackers para robar la contraseña: los 5 métodos más usados}
...
\item
  \href{https://myactivity.google.com/results-about-you}{Google resultados sobre ti}. Hace búsquedas y revisa los resultados sobre ti.
\item
  Haz una búsqueda de imágenes inversa. Con esta búsqueda puedes ver si una imagen tuya, está siendo utilizada en otros sitios web y con qué fin. En el siguiente enlace, tienes la información para llevarla a cabo. \href{https://www.incibe.es/ciudadania/formacion/recursosdescargables/como-hacer-busqueda-imagenes-inversa}{Cómo hacer una búsqueda de imágenes inversa}.
\end{itemize}
...
Una ciberestafa basada en la deepfake es la de la suplantación de un personaje público con el fin de ir creando un ambiente de confianza para finalmente pedir dinero. Si quieres más detalles sobre este fraude online lee el siguiente artículo del Incibe \href{https://www.incibe.es/linea-de-ayuda-en-ciberseguridad/casos-reales/intento-de-fraude-amoroso-utilizando-tecnicas-de-deepfake-para-suplantar-un-personaje-publico}{Intento de fraude amoroso utilizando técnicas de deepfake para suplantar a un personaje público}.
...
\hypertarget{analizadores-de-virus-online}{%
\section{Analizadores de virus online}\label{analizadores-de-virus-online}}
...
\item
  \href{https://www.f-secure.com}{F-secure}.
\end{itemize}
...
\hypertarget{ataques-en-tiempo-real}{%
\section{Ataques en tiempo real}\label{ataques-en-tiempo-real}}
...
\item
  \href{https://www.santanderconsumer.es/simplefinance/blog/tu-futuro/ciberseguridad/post/30-de-noviembre-dia-mundial-de-la-ciberseguridad}{Día mundial de la ciberseguridad} (30 de noviembre)
\end{itemize}
