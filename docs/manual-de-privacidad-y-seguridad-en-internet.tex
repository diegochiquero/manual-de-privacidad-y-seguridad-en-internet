...
En esta línea puedes encontrate lo que se conoce como pretexting o pretexto. Se trata en un ataque más de ingeniería social y que consiste en elaborar un
escenario o historia ficticia, donde el atacante tratará que la víctima comparta información que, en circunstancias normales, no revelaría. También habrá podido notar que es a su vez también es la base del Phishing y del Amishing que verás más adenlante. \citep{RZ-pretexting}
