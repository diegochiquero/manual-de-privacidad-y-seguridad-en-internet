...
Para que puedas hacerte una idea de la magnitud de esta técnica de ingeniería social, en la siguiente entrada del blog oficial de Google llamado [Cocreación para una web más segura: Google y Euroconsumers lanzan Space Shelter en vísperas del Mes Europeo de la Ciberseguridad](https://espana.googleblog.com/2021/09/cocreacion-para-una-web-mas-segura.html), podrás encontrar que con sus algoritmos de detección Google bloquea más de 100 millones diarios de intentos de phishing. 
...
En torno a este concepto también aparece el SPIM (SPam over Instant Messaging), en castellano viniendo a ser como spam a través de mensajería instantánea, puedes leer más en el siguiente artículo [Hablemos de ciberseguridad – III – Spam, SPIM y SPIT](https://www.iniseg.es/blog/ciberseguridad/hablemos-de-ciberseguridad-iii-spam-spim-y-spit/).
...
Puedes leer el artículo completo en [¿Qué es el voice hacking?](https://www.incibe.es/ciudadania/blog/que-es-el-voice-hacking).
