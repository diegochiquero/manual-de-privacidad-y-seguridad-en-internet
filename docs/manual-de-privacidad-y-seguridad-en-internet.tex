...
\begin{itemize}
\item
  Timo Nigeriano: Lotería, viuda, enfermo terminal, herencias, etc \citep{WIKI-timo-nigeriano}.
\item
...
\item
  Novias o novios de orígenes exóticos: Embaucan para posteriormente pedir dinero \citep{INCI-novias-exoticas}.
\item
