...
Para Windows tienes a información en [realizar y restaurar una copia de seguridad del PC](https://support.microsoft.com/es-es/windows/realizar-y-restaurar-una-copia-de-seguridad-del-pc-ac359b36-7015-4694-de9a-c5eac1ce9d9c). Y en dispositivos Apple existe la opción de [cómo hacer copias de seguridad en Mac](https://support.apple.com/es-es/mac-backup).
